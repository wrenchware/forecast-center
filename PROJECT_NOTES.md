...
- Microsoft accepted the initial WinGet submission on 2026-08-30. Package discovery was verified against the public catalog with `winget show --id Wrenchware.ForecastCenter --exact` on 2026-08-31.
